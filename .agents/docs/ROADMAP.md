...
- [ ] [F004 — Upload UI (drag & drop, validation)](features/F004-upload-ui.md) — `S` `UI`
- [ ] [F005 — Parse, display & normalize model](features/F005-model-load-display.md) — `S` `UI/3D`
- [ ] [F006 — Rust: mesh → obstacle voxel grid](features/F006-voxelization.md) — `M` `Rust`

### Phase 2 — Solver Core (Rust)

- [ ] [F007 — LBM D3Q19 core step](features/F007-lbm-core.md) — `M` `Rust`
- [ ] [F008 — Boundary conditions (inlet/outlet/obstacles)](features/F008-boundary-conditions.md) — `M` `Rust`
...
- [ ] [F014 — Particle streamlines](features/F014-particle-streamlines.md) — `M` `UI/3D`
- [ ] [F015 — Surface pressure heatmap](features/F015-pressure-heatmap.md) — `S` `UI/3D`
